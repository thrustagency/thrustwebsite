    ...
    return (
        <div id="privacy-container">
            ...
            <p className="privacy-text">
                ...
                for the management of the Fabio und Silvio Venezia GbR. The use
                of the Internet pages of the Fabio und Silvio Venezia GbR is
            ...
            <p className="privacy-text">
                ...
                protection regulations applicable to the Fabio und Silvio
                Venezia GbR. By means of this data protection declaration, our
            ...
            <br />
            <p className="privacy-text">
                As the controller, the Fabio und Silvio Venezia GbR has
            ...
            <h1>1. Definitions</h1>
            <p className="privacy-text">
                The data protection declaration of the Fabio und Silvio Venezia
                GbR is based on the terms used by the European legislator for
            ...
            <br />
            <h1>2. Name and Address of the controller</h1>
            <p className="privacy-text">
            ...
            <p className="privacy-text">
                ...
                Phone: +491723447461
                <br />
                Email: mail@fabio-venezia.de
                <br />
                Website: www.voxnoxrecords.com
            </p>
            <br />
            <h1>3. Cookies</h1>
            <p className="privacy-text">
                The Internet pages of the Fabio und Silvio Venezia GbR use
                cookies. Cookies are text files that are stored in a computer
            ...
            <br />
            <p className="privacy-text">
                Through the use of cookies, the Fabio und Silvio Venezia GbR can
                provide the users of this website with more user-friendly
            ...
            <br />
            <h1>4. Collection of general data and information</h1>
            <p className="privacy-text">
                The website of the Fabio und Silvio Venezia GbR collects a
            ...
            <br />
            <p className="privacy-text">
                When using these general data and information, the Fabio und
                Silvio Venezia GbR does not draw any conclusions about the data
                ...
                of a cyber-attack. Therefore, the Fabio und Silvio Venezia GbR
                analyzes anonymously collected data and information
                statistically, with the aim of increasing the data protection
                and data security of our enterprise, and to ensure an optimal
                level of protection for the personal data we process. The
                anonymous data of the server log files are stored separately
            ...
            <br />
            <h1>5. Registration on our website</h1>
            <p className="privacy-text">
            ...
            <br />
            <h1>6. Subscription to our newsletters</h1>
            <p className="privacy-text">
                On the website of the Fabio und Silvio Venezia GbR, users are
                given the opportunity to subscribe to our enterprise's
                newsletter. The input mask used for this purpose determines what
                personal data are transmitted, as well as when the newsletter is
                ordered from the controller.
            </p>
            <br />
            <p className="privacy-text">
                The Fabio und Silvio Venezia GbR informs its customers and
                ...
                e-mail address registered by a data subject for the first time
                for newsletter shipping, for legal reasons, in the double opt-in
            ...
            <p className="privacy-text">
                ...
                the (possible) misuse of the e-mail address of a data subject at
                a later date, and it therefore serves the aim of the legal
                protection of the controller.
            </p>
            <br />
            <p className="privacy-text">
                The personal data collected as part of a registration for the
                newsletter will only be used to send our newsletter. In
                addition, subscribers to the newsletter may be informed by
                e-mail, as long as this is necessary for the operation of the
                newsletter service or a registration in question, as this could
                be the case in the event of modifications to the newsletter
                ...
                newsletter may be terminated by the data subject at any time.
                The consent to the storage of personal data, which the data
                subject has given for shipping the newsletter, may be revoked at
                any time. For the purpose of revocation of consent, a
                corresponding link is found in each newsletter. It is also
                possible to unsubscribe from the newsletter at any time directly
                on the website of the controller, or to communicate this to the
                controller in a different way.
            </p>
            <br />
            <h1>7. Newsletter-Tracking</h1>
            <p className="privacy-text">
                The newsletter of the Fabio und Silvio Venezia GbR contains
                so-called tracking pixels. A tracking pixel is a miniature
                graphic embedded in such e-mails, which are sent in HTML format
                to enable log file recording and analysis. This allows a
                statistical analysis of the success or failure of online
                marketing campaigns. Based on the embedded tracking pixel, the
                Fabio und Silvio Venezia GbR may see if and when an e-mail was
            ...
            <p className="privacy-text">
                ...
                the newsletters are stored and analyzed by the controller in
                order to optimize the shipping of the newsletter, as well as to
                adapt the content of future newsletters even better to the
                interests of the data subject. These personal data will not be
                passed on to third parties. Data subjects are at any time
                entitled to revoke the respective separate declaration of
                consent issued by means of the double-opt-in procedure. After a
                revocation, these personal data will be deleted by the
                controller. The Fabio und Silvio Venezia GbR automatically
                regards a withdrawal from the receipt of the newsletter as a
                revocation.
            </p>
            <h1>8. Contact possibility via the website</h1>
            <p className="privacy-text">
                The website of the Fabio und Silvio Venezia GbR contains
                ...
                e-mail or via a contact form, the personal data transmitted by
                the data subject are automatically stored. Such personal data
                transmitted on a voluntary basis by a data subject to the data
                controller are stored for the purpose of processing or
                contacting the data subject. There is no transfer of this
                personal data to third parties.
            </p>
            <h1>9. Routine erasure and blocking of personal data</h1>
            <p className="privacy-text">
            ...
            <h1>10. Rights of the data subject</h1>
            <ul>
                <li>
                ...
                <li>
                    ...
                    <p className="privacy-text">
                        ...
                        safeguards relating to the transfer. If a data subject
                        wishes to avail himself of this right of access, he or
                ...
                <li>
                    ...
                    <p className="privacy-text">
                        ...
                        stored by the Fabio und Silvio Venezia GbR, he or she
                        may, at any time, contact any employee of the
                        controller. An employee of Fabio und Silvio Venezia GbR
                        shall promptly ensure that the erasure request is
                        complied with immediately. Where the controller has made
                        ...
                        as processing is not required. An employees of the Fabio
                        und Silvio Venezia GbR will arrange the necessary
                ...
                <li>
                    ...
                    <p className="privacy-text">
                        ...
                        the erasure of the personal data and requests instead
                        ...
                        processing of personal data stored by the Fabio und
                        Silvio Venezia GbR, he or she may at any time contact
                        any employee of the controller. The employee of the
                        Fabio und Silvio Venezia GbR will arrange the
                ...
                <li>
                    ...
                    <p className="privacy-text">
                        ...
                        provisions.
                        <br />
                        The Fabio und Silvio Venezia GbR shall no longer process
                        the personal data in the event of the objection, unless
                        ...
                        <br />
                        If the Fabio und Silvio Venezia GbR processes personal
                        data for direct marketing purposes, the data subject
                        shall have the right to object at any time to processing
                        of personal data concerning him or her for such
                        marketing. This applies to profiling to the extent that
                        it is related to such direct marketing. If the data
                        subject objects to the Fabio und Silvio Venezia GbR to
                        the processing for direct marketing purposes, the Fabio
                        und Silvio Venezia GbR will no longer process the
                        ...
                        the Fabio und Silvio Venezia GbR for scientific or
                        ...
                        subject may contact any employee of the Fabio und Silvio
                        Venezia GbR. In addition, the data subject is free in
                        the context of the use of information society services,
                        and notwithstanding Directive 2002/58/EC, to use his or
                ...
                <li>
                    ...
                    <p className="privacy-text">
                        ...
                        subject's explicit consent, the Fabio und Silvio Venezia
                        GbR shall implement suitable measures to safeguard the
                        ...
                        his or her point of view and contest the decision. If
                        the data subject wishes to exercise the rights
                        concerning automated individual decision-making, he or
                        she may, at any time, contact any employee of the Fabio
                        und Silvio Venezia GbR.
                    </p>
                </li>
                <li>
                    ...
                    <p className="privacy-text">
                        ...
                        processing of his or her personal data at any time. If
                        the data subject wishes to exercise the right to
                        withdraw the consent, he or she may, at any time,
                        contact any employee of the Fabio und Silvio Venezia
                        GbR.
                    </p>
                </li>
            </ul>
            ...
            <ul>
                ...
                <li>
                    ...
                    <p className="privacy-text">
                        ...
                        personal data will be stored, or, if not possible, the
                        criteria used to determine that period;
                        <br />the existence of the right to request from the
                        controller rectification or erasure of personal data, or
                        restriction of processing of personal data concerning
                        the data subject, or to object to such processing;
                        <br />
                ...
                <li>
                    ...
                    <p className="privacy-text">
                        ...
                        processing is not required. An employees of the Fabio
                        und Silvio Venezia GbR will arrange the necessary
                        measures in individual cases.
                    </p>
                </li>
            ...
            <p className="privacy-text">
                The data controller shall collect and process the personal data
                ...
                submits corresponding application documents by e-mail or by
                means of a web form on the website to the controller. If the
                data controller concludes an employment contract with an
                applicant, the submitted data will be stored for the purpose of
                ...
                automatically erased two months after notification of the
                refusal decision, provided that no other legitimate interests of
                the controller are opposed to the erasure. Other legitimate
                interest in this relation is, e.g. a burden of proof in a
                procedure under the General Equal Treatment Act (AGG).
            </p>
            <br />
            <h1>12. Legal basis for the processing</h1>
            <p className="privacy-text">
            ...
            <br />
            <h1>14. Period for which the personal data will be stored</h1>
            <p className="privacy-text">
            ...
            <br />
            <h1>16. Existence of automated decision-making</h1>
            <p className="privacy-text">
                ...
                 that was developed in cooperation with the <a
                    href="https://www.wbs-law.de/eng/practice-areas/media-law/"
                    target="_blank"
                >
                    {" "}
                    Media Law Lawyers
